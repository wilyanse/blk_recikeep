...
async function main() {
    ...
    const sampleRecipes = [
      {
        ...
        tokenURI: "https://ipfs.io/ipfs/QmaMNQyuP7NJB9qVY8apzPMorAtmYBDZ68za92BxnVwLut"
      },
      {
        ...
        tokenURI: "https://ipfs.io/ipfs/QmfMDGaArRbVpYHUizB8QqE7ZZ3rv8v5UoNTz9Pu7gvQF4"
      },
      {
        name: "Mung Bean Soup",
        ...
        imageUrl: "https://pinchofyum.com/wp-content/uploads/2013/04/monggo-soup-3.jpg",
        tokenURI: "https://ipfs.io/ipfs/QmciosYTowcRUmMtMu81k2UWa9ze8twQ5v4QEaqz1R64ZH"
      }
    ];
    ...
    for (const recipe of sampleRecipes) {
      await recipeNFT.createRecipeNFT(recipe.name, recipe.ingredients, recipe.steps, recipe.imageUrl, recipe.tokenURI);
