<script lang="ts">
  ...
  <main class='flex flex-col items-center justify-center'>
    <div class='max-w-6xl justify-items-center my-10 flex flex-col'>
      <h1 class="text-4xl font-bold mb-8 justify-center h1 text-center">Listings Gallery</h1>
      <button type="button" class="btn variant-filled mx-5 justify-items-center flex " on:click={createListing}>
    ...
    <TreeView class="max-w-4xl justify-items-center my-4 grid grid-cols-1">
      <TreeViewItem class="w-max">
